...
# Averaging done by convlving the image with a normalize box filter 
...
# Instead of using Box filter use gaussian kernel
Gaussian = cv2.GaussianBlur(img, (7,7), 0)
cv2.imshow('Gaussian Blur Image', Gaussian)
cv2.waitKey(0)


# Take median of all the pixels under kernel area and central element is replaced with the median value
